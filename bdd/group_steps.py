...
def none_empty_group_list(db, app):
...
def random_group(none_empty_group_list):
    return random.choice(none_empty_group_list)
...
def veriy_group_deleted(db, none_empty_group_list, random_group, app, check_ui):
    old_groups = none_empty_group_list
    new_groups = db.get_group_list()
